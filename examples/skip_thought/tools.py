...
from skip_thought.utils import load_params, init_tparams
from skip_thought.model import init_params, build_encoder, build_encoder_w2v
...
def load_googlenews_vectors(path, binary = True):
    ...
    embed_map.init_sims(replace=True)
    return embed_map
