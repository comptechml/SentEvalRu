...
SentEvalRuRu позволяет вам оценить эмбеддинги предложений для следующих [задач](\data\README.md):
...
Код написан на языке python. Зависимости проекта:
...
Вы можете скачать [Anaconda](https://www.anaconda.com/distribution/), которая включает все необходимые библиотеки. 
...
Чтобы оценить ваши эмбеддинги предложений, добавляя ваши данные и алгоритм векторизации, SentEvalRuRu требует, чтобы вы реализовали две функции: *prepare* and *batcher*. После реализации вы должны задать параметры SentEvalRuRu. Далее SentEvalRuRu позаботится об оценке задач, переданных на обучение, используя эмбеддинги как признаки.
